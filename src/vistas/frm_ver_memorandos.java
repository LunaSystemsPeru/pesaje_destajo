...
import formularios.frm_reg_memorando;
 ...
 * @author luis
 */
public class frm_ver_memorandos extends javax.swing.JInternalFrame {

    cl_varios c_varios = new cl_varios();
    cl_memoramdo c_memorando = new cl_memoramdo();
    ...
    public frm_ver_memorandos() {
        initComponents();
        query = "select memorandos.fecha, memorandos.id_memorandum, memorandos.descripcion, trabajadores_sucursal.colaborador "
                + "from memorandos "
                + "inner join trabajadores_sucursal on trabajadores_sucursal.id_cliente = memorandos.id_cliente and trabajadores_sucursal.id_sucursal = memorandos.id_sucursal and trabajadores_sucursal.id_trabajador = memorandos.id_trabajador "
                + "where memorandos.fecha = current_date";
        System.out.println(query);
        c_memorando.mostrar(t_memorando, query);
    }
    ...
    private void btn_nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_nuevoActionPerformed
        ...
        frm_reg_memorando.registrar = true;
        frm_reg_memorando formulario = new frm_reg_memorando();
        c_varios.llamar_ventana(formulario);
        this.dispose();
    }//GEN-LAST:event_btn_nuevoActionPerformed

    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        frm_reg_memorando.c_memorando.setId_memorando(c_memorando.getId_memorando());
        frm_reg_memorando.registrar = false;
        frm_reg_memorando reg_trabajo = new frm_reg_memorando();
    ...
    private void t_memorandoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_t_memorandoMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            //capturar id cliente
            c_memorando.setId_memorando(Integer.parseInt(t_memorando.getValueAt(fila_seleccionada, 0).toString()));
    ...
    private void txt_buscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            query = "select memorandos.fecha, memorandos.id_memorandum, memorandos.descripcion, trabajadores_sucursal.colaborador "
                    + "from memorandos "
                    + "inner join trabajadores_sucursal on trabajadores_sucursal.id_cliente = memorandos.id_cliente and trabajadores_sucursal.id_sucursal = memorandos.id_sucursal and trabajadores_sucursal.id_trabajador = memorandos.id_trabajador "
                    + "where memorandos.fecha = '" + buscar + "' or  trabajadores_sucursal.colaborador like '%" + buscar + "%' ";
            c_memorando.mostrar(t_memorando, query);
        }
