...
public class JsonAPI {
    ...
    public String getJsonCuentasServidor() {
        ...
        try {
            ...
            String url = "https://gthconsultora.ga/ajax/obtenerListaObrerosCuenta.php";
    ...
    public void crearJsonDnis(ArrayList dnis) {
        ...
        String url = "https://gthconsultora.ga/ajax/obtenerCuentasxDocumento.php";
    ...
    public void enviarCuentas (String json) {
        String url = "https://gthconsultora.ga/ajax/obtenerCuentasModificadas.php";
